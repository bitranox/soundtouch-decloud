...
| Diagnostic port 17000, opening SSH over it and its precondition, making it survive a reboot, the clock repair, setting the timezone (/mnt/nv/localtime), clockDisplay and language over the API | references/access-and-rooting.md |
